...
#10X data
exprs <- readMM("load_scripts/cell_line/GSE103867/GSE103867_matrix.mtx")
barcodes <- read.table("load_scripts/cell_line/GSE103867/GSE103867_barcodes.tsv")$V1
genes <- read.table("load_scripts/cell_line/GSE103867/GSE103867_genes.tsv")$V1
...
huh1_aucs <- ppi_comp(objects[[1]], huh1, run.PCA=TRUE)
huh7_aucs <- ppi_comp(objects[[2]], huh7, run.PCA=TRUE)
write.csv(huh1_aucs, here("results","aucs","pca", "HUH1_PCA.csv"))
write.csv(huh7_aucs, here("results", "aucs", "pca", "HUH7_PCA.csv"))
rm(list=ls())
