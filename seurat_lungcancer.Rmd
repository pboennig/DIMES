...
mi.two <- dist_matrix(cells = comb.cells, counts = counts, metric = "MI") %>% as_tbl_graph(directed = FALSE)
...
```{r create plots}
save_gene_clusters(mi.graph, "minmax/original method mi")
save_gene_clusters(mi.two, "minmax/dismay method mi")
```
